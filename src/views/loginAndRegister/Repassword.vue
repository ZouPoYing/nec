    ...
    <div id="repassword">
        <form>
            ...
            <div class="div-password">
                <input type="password" placeholder="请输入新密码" v-model="register.password" class="password" @blur="password" />
            </div>
        ...
        methods: {
            getCode() {
                if (this.regEmail == '') {
                    ...
                    axios.post('http://192.168.1.106:9191/ncm/user/reGetEmailNumber', obj,{
                            headers: {
            ...
            submit() {
                if (this.regEmail == '' || this.regCode == '' || this.regPassword == '') {
                    ...
                    console.log(obj);
                    axios.post('http://192.168.1.106:9191/ncm/user/rePassword', obj,{
                            headers: {
                                'Content-Type': 'application/json;charset=UTF-8'
                            },
                            withCredentials: true
